...
const evmAccount0 = {
    ...
    privateKey: Buffer.from(
        'd86dd54fd92f7c638668b1847aa3928f213db09ccda19f1a5f2badeae50cb93e',
        'hex'
    )
}
...
let DEPLOY_CONTRACT = async () => {
    ...
    let GREET_CONTRACT = new web3.eth.Contract([
        {
...
let GET_TX_RECEIPT_TO_GET_CONTRACT_ADDRESS = async () => {
    let receipt = await web3.eth.getTransactionReceipt(
        '0xabc67e4868cb3a90acc39a48ce381e11cbde0a19df7b30b58eb14898edf5713c'
    )
...
let SET_GREETING_IN_SANDBOX = async () => {
    ...
    console.log(
        'Current greeting is: ',
        await GREET_CONTRACT.methods.setGreeting('This is the new value for greeting: Hola').call()
    )
}
...
let ESTIMATE_GAS_FOR_GREETING_SET = async () => {
    ...
    let gasAmount = await GREET_CONTRACT.methods
        .setGreeting(
            'aaaaaaaaaaaaaaaaaaaaaaaqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa'
        )
        .estimateGas({ from: evmAccount0.address })
