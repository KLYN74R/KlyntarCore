...
console.log(signaturesLinked ? " тЬЕ Signatures 1 and 2 are linked" : "тЭМ Signatures 1 and 2 are not linked")
...
try {
        ...
        console.log(isValid3 ? "тЭМ The altered signature is valid" : " тЬЕ The altered signature is invalid")
        console.log(extraneousSignaturesLinked2 ? " тЬЕ Altered signatrues 1 and 2 are linked" : "тЭМ Altered signatrues 1 and 2 are not linked")
        console.log(differentSignaturesLinked ? "тЭМ Signature 1 and altered signature 2 are linked" : " тЬЕ Signature 1 and altered signature 2 are not linked")
}
catch (err) {
        console.log(err)
}