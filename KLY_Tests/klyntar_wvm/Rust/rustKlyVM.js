...
try {
    let attempt2 = JSON.stringify({
        alias1: 'Cool',
        alias2: 'KLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLYKLY',
        x: 1337,
        y: result.result
    })

    let result2 = VM.callContract(
        contractInstance,
        contractMetadata,
        attempt2,
        'getCoordsSum',
