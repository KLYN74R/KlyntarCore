...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_2.getDataSlice)(
    ...
    [
        ...
        async function (runState) {
            ...
            const size = BigInt(
                (
                    await runState.eei.getContractCode(
                        new util_1.Address((0, util_2.addressToBuffer)(addressBigInt))
                    )
                ).length
            )
    ...
    [
        ...
        async function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const code = await runState.eei.getContractCode(
                    new util_1.Address((0, util_2.addressToBuffer)(addressBigInt))
                )
    ...
    [
        ...
        function (runState) {
            ...
            if (dest > runState.interpreter.getCodeSize()) {
                ;(0, util_2.trap)(
                    exceptions_1.ERROR.INVALID_JUMP +
                        ' at ' +
                        (0, util_2.describeLocation)(runState)
                )
            }
    ...
    [
        ...
        function (runState) {
            ;(0, util_2.trap)(
                exceptions_1.ERROR.INVALID_BEGINSUB +
                    ' at ' +
                    (0, util_2.describeLocation)(runState)
            )
        }
    ...
    [
        ...
        function (runState) {
            ...
            if (dest > runState.interpreter.getCodeSize()) {
                ;(0, util_2.trap)(
                    exceptions_1.ERROR.INVALID_JUMPSUB +
                        ' at ' +
                        (0, util_2.describeLocation)(runState)
                )
            }
    ...
    [
        ...
        function (runState, common) {
            ...
            const loaded = (0, util_1.bufferToBigInt)(
    ...
    [
        ...
        async function (runState) {
            ...
            const ret = await runState.interpreter.create2(
                ...
                value,
                data,
                (0, util_1.setLengthLeft)((0, util_1.bigIntToBuffer)(salt), 32)
            )
            runState.stack.push(ret)
        }
    ],
    ...
    [
        ...
        async function (runState) {
            ...
            const paddedInvokerAddress = (0, util_1.setLengthLeft)(
                runState.interpreter._env.address.buf,
                32
            )
            const chainId = (0, util_1.setLengthLeft)(
                (0, util_1.bigIntToBuffer)(runState.interpreter.getChainId()),
                32
            )
            ...
            const expectedAddress = new util_1.Address(
                (0, util_1.setLengthLeft)((0, util_1.bigIntToBuffer)(authority), 20)
            )
    ...
    [
        ...
        async function (runState) {
            ...
            const selfdestructToAddress = new util_1.Address(
                (0, util_2.addressToBuffer)(selfdestructToAddressBigInt)
            )
