...
export default class ContractInstance {
    ...
    getStringFromWasm0 = (ptr, len) =>
        cachedTextDecoder.decode(this.getUint8Memory0().subarray(ptr, ptr + len))
    ...
    __wbg_adapter_XXX = (arg0, arg1, arg2) => {
        this.wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h4f14a7dea6bdf9dd(
            arg0,
            arg1,
            this.addHeapObject(arg2)
        )
    }
    ...
    __wbg_adapter_X(arg0, arg1, arg2, arg3) {
        this.wasm.wasm_bindgen__convert__closures__invoke2_mut__hb6099109a8545842(
            arg0,
            arg1,
            this.addHeapObject(arg2),
            this.addHeapObject(arg3)
        )
    }
